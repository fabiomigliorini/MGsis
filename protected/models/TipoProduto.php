...
/**
 * This is the model class for table "mgsis.tbltipoproduto".
 *
 * The followings are the available columns in table 'mgsis.tbltipoproduto':
...
class TipoProduto extends MGActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('codtipoproduto, tipoproduto, alteracao, codusuarioalteracao, criacao, codusuariocriacao', 'safe', 'on'=>'search'),
		);
	}
