...
class NfeTerceiroDuplicata extends MGActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('codtitulo, dvenc', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('codnfeterceiroduplicata, codnfeterceiro, codtitulo, ndup, dvenc, vdup', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'codnfeterceiro' => array(self::BELONGS_TO, 'Nfeterceiro', 'codnfeterceiro'),
