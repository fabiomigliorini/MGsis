...
class LiquidacaoTitulo extends MGActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('criacao_de, criacao_ate, codliquidacaotitulo, transacao, codportador, observacao, estornado, alteracao, codusuarioalteracao, criacao, codusuariocriacao, debito, credito, codpessoa', 'safe', 'on'=>'search'),
		);
	}
