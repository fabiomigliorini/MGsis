...
/**
 * This is the model class for table "mgsis.tblgrupoproduto".
 *
 * The followings are the available columns in table 'mgsis.tblgrupoproduto':
 * @property string $codgrupoproduto
 * @property string $grupoproduto
...
class GrupoProduto extends MGActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('codgrupoproduto, grupoproduto, alteracao, codusuarioalteracao, criacao, codusuariocriacao', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GrupoProduto the static model class
	 */
