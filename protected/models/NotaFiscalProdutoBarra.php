...
class NotaFiscalProdutoBarra extends MGActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('pispercentual, cofinspercentual, csllpercentual, irpjpercentual', 'length', 'max' => 9),
    ...
    public function recalculaTributacao()
    {
        $this->codcfop = null;

        $this->icmscst = null;
        $this->icmsbasepercentual = null;
        $this->icmsbase = null;
        $this->icmspercentual = null;
        $this->icmsvalor = null;

        $this->pisbase = null;
        $this->pispercentual = null;
        $this->pisvalor = null;

        $this->cofinsbase = null;
        $this->cofinspercentual = null;
        $this->cofinsvalor = null;

        $this->csllbase = null;
        $this->csllpercentual = null;
        $this->csllvalor = null;

        $this->irpjbase = null;
        $this->irpjpercentual = null;
        $this->irpjvalor = null;

        $this->calculaTributacao(false);
    }
