...
class PessoaCertidaoController extends Controller
{
	...
	*/
	...
	{
		$model=new PessoaCertidao;
		$model->codpessoa = $codpessoa;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['PessoaCertidao']))
		{
			$model->attributes=$_POST['PessoaCertidao'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->codpessoacertidao));
		}
	...
	*/
	...
	{
		$model=new PessoaCertidao('search');
		...
		if (isset(Yii::app()->session['FiltroPessoaCertidaoIndex']))
			$model->attributes=Yii::app()->session['FiltroPessoaCertidaoIndex'];
	...
	*/
	public function actionAdmin()
	{
		...
		if(isset($_GET['PessoaCertidao']))
			$model->attributes=$_GET['PessoaCertidao'];
	...
	*/
	...
	{
		$model=PessoaCertidao::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pessoa-certidao-form')
		{
