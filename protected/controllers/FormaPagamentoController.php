...
class FormaPagamentoController extends Controller
{
	...
	*/
	...
	{
		$this->redirect(APP_CONTAS_URL . '/forma-pagamento');
	...
	*/
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['FormaPagamento'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->codformapagamento));
		}
	...
	*/
	public function actionIndex()
	{
		...
		if(isset($_GET['FormaPagamento']))
			Yii::app()->session['FiltroFormaPagamentoIndex'] = $_GET['FormaPagamento'];
		
		if (isset(Yii::app()->session['FiltroFormaPagamentoIndex']))
			$model->attributes=Yii::app()->session['FiltroFormaPagamentoIndex'];
