...
class BancoController extends Controller
{
	...
	*/
	...
	{
		$this->redirect(APP_CONTAS_URL . '/banco');
	...
	*/
	public function actionCreate()
	{
		...
		if(isset($_POST['Banco']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->codbanco));
		}
	...
	*/
	public function actionIndex()
	{
		...
		if(isset($_GET['Banco']))
			Yii::app()->session['FiltroBancoIndex'] = $_GET['Banco'];
		
		if (isset(Yii::app()->session['FiltroBancoIndex']))
			$model->attributes=Yii::app()->session['FiltroBancoIndex'];
