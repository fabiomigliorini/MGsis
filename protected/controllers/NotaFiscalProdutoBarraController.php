...
class NotaFiscalProdutoBarraController extends Controller
{
	...
	*/
	public function actionCreate()
	{
		...
		if(isset($_POST['NotaFiscalProdutoBarra']))
		{
	...
	*/
	...
	{
		$model=new NotaFiscalProdutoBarra('search');
		...
		if (isset(Yii::app()->session['FiltroNotaFiscalProdutoBarraIndex']))
			$model->attributes=Yii::app()->session['FiltroNotaFiscalProdutoBarraIndex'];
	...
	*/
	public function actionAdmin()
	{
		...
		if(isset($_GET['NotaFiscalProdutoBarra']))
			$model->attributes=$_GET['NotaFiscalProdutoBarra'];
	...
	*/
	...
	{
		$model=NotaFiscalProdutoBarra::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='nota-fiscal-produto-barra-form')
		{
