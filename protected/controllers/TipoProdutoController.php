...
class TipoProdutoController extends Controller
{
	...
	*/
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['TipoProduto'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->codtipoproduto));
		}
	...
	*/
	public function actionIndex()
	{
		...
		if(isset($_GET['TipoProduto']))
			Yii::app()->session['FiltroTipoProdutoIndex'] = $_GET['TipoProduto'];
		
		if (isset(Yii::app()->session['FiltroTipoProdutoIndex']))
			$model->attributes=Yii::app()->session['FiltroTipoProdutoIndex'];
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-produto-form')
		{
