...
class ProdutoHistoricoPrecoController extends Controller
{
	...
	*/
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ProdutoHistoricoPreco']))
		{
			$model->attributes=$_POST['ProdutoHistoricoPreco'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->codprodutohistoricopreco));
		}
	...
	*/
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['ProdutoHistoricoPreco']))
			$model->attributes=$_GET['ProdutoHistoricoPreco'];
	...
	*/
	...
	{
		$model=ProdutoHistoricoPreco::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='produto-historico-preco-form')
		{
