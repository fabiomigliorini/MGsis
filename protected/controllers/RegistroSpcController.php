...
class RegistroSpcController extends Controller
{
	/**
	...
	*/
	public function actionIndex()
	{
		...
		if (isset(Yii::app()->session['FiltroRegistroSpcIndex']))
			$model->attributes=Yii::app()->session['FiltroRegistroSpcIndex'];
	...
	*/
	public function actionAdmin()
	{
		...
		if(isset($_GET['RegistroSpc']))
			$model->attributes=$_GET['RegistroSpc'];
	...
	*/
	...
	{
		$model=RegistroSpc::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='registro-spc-form')
		{
