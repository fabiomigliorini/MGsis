...
<div class="well well-small">
    <div class="row-fluid">
        ...
        <?php echo $form->select2GrupoEconomico($model, 'codgrupoeconomico', array('placeholder' => 'Grupo Econômico', 'class' => 'input-xlarge')); ?>
        ...
        ?>
        <?php echo $form->numberField($model, 'valor_de', array('placeholder' => 'Total De', 'class' => 'input-mini text-right', 'type' => 'number', 'min' => 0.01, 'step' => 0.01)); ?>
        <?php echo $form->numberField($model, 'valor_ate', array('placeholder' => 'Total Até', 'class' => 'input-mini text-right', 'type' => 'number', 'min' => 0.01, 'step' => 0.01)); ?>
        <?php
        $this->widget(
