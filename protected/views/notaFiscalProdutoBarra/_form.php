            ...
            <div class="tab-pane active" id="tabProduto">
                <div class="row-fluid">
                    <div class="span12" style="max-width: 90vw">
                        <?php
                        echo $form->textFieldRow($model, 'ordem', array('class' => 'input-mini text-right'));
...
<script type='text/javascript'>
    ...
    $(document).ready(function() {
        ...
        $('#NotaFiscalProdutoBarra_ordem').autoNumeric('init', {
            aSep: '',
            aDec: ',',
            altDec: '.',
            mDec: 0
        ...
        $('#NotaFiscalProdutoBarra_pedidoitem').autoNumeric('init', {
            aSep: '',
            aDec: ',',
            altDec: '.',
            mDec: 0
        ...
        $('#NotaFiscalProdutoBarra_quantidade').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_valorunitario').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.',
            mDec: 10
        });
        $('#NotaFiscalProdutoBarra_valortotal').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_valorfrete').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_valorseguro').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_valordesconto').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_valoroutras').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_valortotalfinal').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_icmsbase').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_icmsbasepercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_icmspercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_icmsvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_icmsstbase').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_icmsstpercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_icmsstvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_ipibase').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_ipipercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_ipivalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_ipidevolucaovalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_devolucaopercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_pisbase').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_pispercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_pisvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_cofinsbase').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_cofinspercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_cofinsvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        ...
        $('#NotaFiscalProdutoBarra_csllpercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_csllvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_irpjbase').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_irpjpercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });
        $('#NotaFiscalProdutoBarra_irpjvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_fethabkg').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.',
            mDec: 6
        });
        $('#NotaFiscalProdutoBarra_fethabvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_iagrokg').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.',
            mDec: 6
        });
        $('#NotaFiscalProdutoBarra_iagrovalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_funruralpercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.',
            mDec: 5
        });
        $('#NotaFiscalProdutoBarra_funruralvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_senarpercentual').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.',
            mDec: 5
        });
        $('#NotaFiscalProdutoBarra_senarvalor').autoNumeric('init', {
            aSep: '.',
            aDec: ',',
            altDec: '.'
        });

        $('#NotaFiscalProdutoBarra_quantidade').change(function() {
            atualizaTotal();
        });
        $('#NotaFiscalProdutoBarra_valorunitario').change(function() {
            atualizaTotal();
        });
        $('#NotaFiscalProdutoBarra_valortotal').change(function() {
            atualizaUnitario();
        });

        $('#NotaFiscalProdutoBarra_valordesconto').change(function() {
            atualizaTotalFinal();
        });
        $('#NotaFiscalProdutoBarra_valorfrete').change(function() {
            atualizaTotalFinal();
        });
        $('#NotaFiscalProdutoBarra_valorseguro').change(function() {
            atualizaTotalFinal();
        });
        $('#NotaFiscalProdutoBarra_valoroutras').change(function() {
            atualizaTotalFinal();
        });

        $('#NotaFiscalProdutoBarra_icmsbase').change(function() {
            atualizaImposto('icms', 'base');
        });
        $('#NotaFiscalProdutoBarra_icmsbasepercentual').change(function() {
            atualizaImposto('icms', 'basepercentual');
        });
        $('#NotaFiscalProdutoBarra_icmspercentual').change(function() {
            atualizaImposto('icms', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_icmsvalor').change(function() {
            atualizaImposto('icms', 'valor');
        });

        $('#NotaFiscalProdutoBarra_icmsstbase').change(function() {
            atualizaImposto('icmsst', 'base');
        });
        $('#NotaFiscalProdutoBarra_icmsstpercentual').change(function() {
            atualizaImposto('icmsst', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_icmsstvalor').change(function() {
            atualizaImposto('icmsst', 'valor');
        });

        $('#NotaFiscalProdutoBarra_ipibase').change(function() {
            atualizaImposto('ipi', 'base');
        });
        $('#NotaFiscalProdutoBarra_ipipercentual').change(function() {
            atualizaImposto('ipi', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_ipivalor').change(function() {
            atualizaImposto('ipi', 'valor');
        });

        $('#NotaFiscalProdutoBarra_pisbase').change(function() {
            atualizaImposto('pis', 'base');
        });
        $('#NotaFiscalProdutoBarra_pispercentual').change(function() {
            atualizaImposto('pis', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_pisvalor').change(function() {
            atualizaImposto('pis', 'valor');
        });

        $('#NotaFiscalProdutoBarra_cofinsbase').change(function() {
            atualizaImposto('cofins', 'base');
        });
        $('#NotaFiscalProdutoBarra_cofinspercentual').change(function() {
        ...
        $('#NotaFiscalProdutoBarra_csllpercentual').change(function() {
            atualizaImposto('csll', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_csllvalor').change(function() {
            atualizaImposto('csll', 'valor');
        });

        $('#NotaFiscalProdutoBarra_irpjbase').change(function() {
            atualizaImposto('irpj', 'base');
        });
        $('#NotaFiscalProdutoBarra_irpjpercentual').change(function() {
            atualizaImposto('irpj', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_irpjvalor').change(function() {
            atualizaImposto('irpj', 'valor');
        });

        $('#NotaFiscalProdutoBarra_fethabkg').change(function() {
            atualizaImpostoKg('fethab', 'kg');
        });
        $('#NotaFiscalProdutoBarra_fethabvalor').change(function() {
            atualizaImpostoKg('fethab', 'valor');
        });

        $('#NotaFiscalProdutoBarra_iagrokg').change(function() {
            atualizaImpostoKg('iagro', 'kg');
        });
        $('#NotaFiscalProdutoBarra_iagrovalor').change(function() {
            atualizaImpostoKg('iagro', 'valor');
        });

        $('#NotaFiscalProdutoBarra_funruralpercentual').change(function() {
            atualizaImposto('funrural', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_funruralvalor').change(function() {
            atualizaImposto('funrural', 'valor');
        });

        $('#NotaFiscalProdutoBarra_senarpercentual').change(function() {
            atualizaImposto('senar', 'percentual');
        });
        $('#NotaFiscalProdutoBarra_senarvalor').change(function() {
