<div class="registro row-fluid">
	<small class="span1 muted">
		...
		<b class="span2"><?php echo CHtml::link(CHtml::encode($data->filial),array('view','id'=>$data->codfilial)); ?></b>
	
		<small class="span1"><?php echo CHtml::encode($data->codempresa); ?></small>

		<small class="span1"><?php echo CHtml::encode($data->codpessoa); ?></small>
