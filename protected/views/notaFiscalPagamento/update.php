...
$this->pagetitle = Yii::app()->name . ' - Alterar Pagamento';
$this->breadcrumbs = array(
    ...
    Yii::app()->format->formataCodigo($model->codnotafiscalpagamento),
    'Alterar',
);
...
<h1>Alterar Pagamento <?php echo Yii::app()->format->formataCodigo($model->codnotafiscalpagamento); ?></h1>
<br>
