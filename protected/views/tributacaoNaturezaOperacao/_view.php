<div class="registro row-fluid">
		<small class="span1"><?php echo CHtml::link(CHtml::encode(Yii::app()->format->formataCodigo($data->codtributacaonaturezaoperacao)),array('view','id'=>$data->codtributacaonaturezaoperacao)); ?></small>
		...
		<b class="span1 muted"><?php echo CHtml::encode($data->TipoProduto->tipoproduto); ?></b>
