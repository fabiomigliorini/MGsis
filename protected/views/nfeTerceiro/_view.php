...
<div class="registro row-fluid">
	...
	<div class="span1 text-right">
		...
		<small class="muted">
			<?php echo CHtml::encode($data->Operacao->operacao); ?>
		</small>
	</div>
	
	<small class="span4 muted">
		<?php echo CHtml::link(CHtml::encode(Yii::app()->format->formataChaveNfe($data->nfechave)),array('view','id'=>$data->codnfeterceiro)); ?><br>
		NSU: <?php echo CHtml::encode($data->nsu); ?> |
		Situação: <?php echo CHtml::encode($data->indsituacao); ?> |
		Manifestação: <?php echo CHtml::encode($data->indmanifestacao); ?>
	</small>
