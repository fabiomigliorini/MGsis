...
<script type="text/javascript">
    function imprimirComanda(event) {
        ...
        $.ajax({
            ...
            $.notify("Comanda enviada para impressão na impressora '" + impressora + "'!", {
                position: "right bottom",
                className: "success",
                autoHideDelay: 15000
            });
        }).fail(function(jqxhr, textStatus, error) {
            $.notify("Erro ao Imprimir Comanda!", {
                position: "right bottom",
                className: "error",
                autoHideDelay: 15000
            });
    ...
    $(document).ready(function() {
        ...
        ?>
                window.history.pushState({
                    page: null
                }, null, '<?php echo Yii::app()->createUrl('negocio/view', ['id' => $model->codnegocio, 'perguntarNota' => false]) ?>');
                bootbox.hideAll();
