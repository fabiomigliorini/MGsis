<div class="well">
    ...
    <?php endif; ?>
    <?php if ($model->valorfrete > 0): ?>
        <div class=" muted">
            <div class="span5">
                Frete
    			<?php if (!empty($model->codpessoatransportador)): ?>
    ...
    <?php if ($model->valorjuros > 0): ?>
        <div class=" muted">
            ...
            <strong class="span7 text-right" style="font-size: x-large">
                R$
                <?php echo Yii::app()->format->formatNumber($model->valorjuros); ?>
            </strong>
        </div>
    <?php endif; ?>
    <?php if ($model->valorprodutos != $model->valortotal):	?>
    	<hr>
